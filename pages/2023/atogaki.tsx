...
export default function Page() {
  return (
    <Pagination author={'atogaki'} pageCount={1}>
      <div>
        <h2>編集後記</h2>
        <p>タイトルが意味不明と定評のある「<strong>サイバーメタルチンピラ</strong>」ですが、お楽しみいただけたでしょうか？私含め著者たちもタイトルの意味が理解できません(意味など考えずに命名したので当然なのですが)。著者の一部から「チンピラのくせに行儀が良すぎる」との謎の苦情が殺到し、チンピラ性の違い(？)で大喧嘩したこともありました。謎すぎる。</p>
        <p>表紙絵は昨年に引き続きAIによって生成されました。「サイバーメタルチンピラガール」という単語だけで表紙の彼女が生まれました。AIの進化は凄まじいものを感じますね。</p>
        <p>本誌は「<strong>ノンジャンルなんでもあり情報誌</strong>」として年１回の頒布を目指しております。2022年に続いて2023年も製本できたこと大変嬉しく思います。来年2024年末も皆様にお会いできますことを楽しみにしております。インターネット最高！！！</p>
