...
export default function Page() {
  return (
    <Pagination author={'kuri'} pageCount={1}>
      <Title
      ...
      <p>Stable Diffusion、Midjourney、DALL·E 3と有名なものはたくさんありますが、今回のテーマ的には日本語のプロンプトで簡単に美少女イラストが手に入る『にじジャーニー（niji・journey）』がぴったりだったので、にじジャーニーのみで生成しています。</p>
