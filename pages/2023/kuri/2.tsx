...
export default function Page() {
  return (
    <Pagination page={999}>
      ...
      <h3>にじジャーニーでの画像生成</h3>
      <p>Discordの「画像生成」カテゴリのチャンネルにて、『/imagine prompt {'{生成したい画像のキーワード}'}』
        を入力します。（promptは自動で入力されます）プロンプトに入力するキーワードは日本語でも大丈夫です。</p>
      <div style={{display: 'flex'}}>
        <Image href={'/2023/kuri/kuri3.png'} description={'画像生成カテゴリ'} widthPercentage={30}/>
        <Image href={'/2023/kuri/kuri4.png'} description={'/imagine prompt {生成したい画像のキーワード} のフォーマットでプロンプトを入力'}
               widthPercentage={65}/>
      </div>
    </Pagination>
  )
