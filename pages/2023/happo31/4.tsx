...
export default function Page() {
  return (
    <Pagination author={'happo31'} pageCount={4}>
      ...
      <h3>eSIM 対応</h3>
      <p>物理 SIM を刺さなくてよくなるやつ。物理 SIM と組み合わせて複数待ち受け[3]なんかが出来る端末もあります。最近は結構対応しているキャリアが増えてきてるので一応見ておくといいかも。僕が使っている
        IIJmio のギガプラン[4]では、通話 eSIM がドコモ回線に最近対応したので物理SIMから乗り換えました。</p>
