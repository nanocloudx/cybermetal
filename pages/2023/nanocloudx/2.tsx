...
export default function Page() {
  return (
    <Pagination page={999}>
      <h2>免責</h2>
      <p><strong>この記事は結婚を強く推奨するものではない。</strong>価値観や生き方は人それぞれだ。<br />本稿の対象読者は「結婚願望があるのに何もしていない人」に向けたものである。</p>
      ...
      <p>人生における<strong>幸福感は５０歳前後で最低になる</strong>との論文がある[^2][^3]。中高年期に訪れる幸福感の沈み込みを緩和できるのは「金」と「結婚」の２つらしい。関係良好な夫婦は独身よりも人生の幸福感が高く、中高年期の沈み込みも緩和されていることがわかる。(ちなみに富裕層は既婚だろうが未婚だろうが幸福感は高いらしい。宝くじも買うか...)</p>
